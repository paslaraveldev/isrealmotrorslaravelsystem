<!-- resources/views/sport_cars/create.blade.php -->
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Create Sport Car</div>

                    <div class="card-body">
                        <form action="{{ route('sport_cars.store') }}" method="POST">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-primary">Create Sport Car</button>
                        </form>
                    </div>
                </div>
            </div>
