...
@section('content')
    <h1 class="text-center my-4">Luxury Cars</h1>
                ...
                <div class="card h-100">
                    <form action="{{ route('carorders.store') }}" method="POST">
                        ...
                        <!-- Add more hidden fields as needed -->
                         <img src="{{ asset('assets/img/WhatsApp Image 2024-04-15 at 14.50.48_6812e32d.jpg') }}" class="card-img-top" alt="{{ $car->make }} {{ $car->model }}" style="width: 200px; height: 200px; object-fit: cover;">
                        <div class="card-body">
